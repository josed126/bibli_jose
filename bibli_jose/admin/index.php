...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="../usuarios/images/icons/favicon.ico"/>
<!--===============================================================================================-->
...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="../usuarios/images/img-01.png" alt="IMG">
				</div>
		...
		if(isset($_POST['l_login']))
		{
			...
			if(mysqli_num_rows($query->get_result()) != 1)
				echo error_without_field("Nombre de Usuarioso contraseña incorrectos");
			else
			{
	...
	?>
					...
					<input  type="text" name="l_user" placeholder="Usuario" class="form-control my-input" required />
					...
					<input type="password" name="l_pass" placeholder="Contraseña"  class="form-control my-input" required>
						<span class="focus-input100"></span>
					...
					<button type="submit" class="login100-form-btn" name="l_login">Iniciar Sesion</button>
					</div>
					<div class="text-center p-t-136">
						<a class="txt2" href="../usuarios" >
							Entrar como Usuario
